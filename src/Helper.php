...
abstract class Helper
{
  ...
  protected static $translations = [
    ...
    'CANNOT_FIND_SOURCE'  => 'Impossible de trouver la source',
    'ALREADY_EXISTS'      => 'Existe',
    'NOT_A_FOLDER'        => 'Le chemin n\'est pas un dossier',
    'FAILED_CREATING'     => 'Échec de la création',
    'FAILED_DELETING'     => 'Échec de la suppression',
    'FAILED_RENAMING'     => 'Échec du renommage',
    'FAILED_CHMOD'        => 'Impossible de modifier les permissions du fichier',
    'FAILED_MOVE_UPLOAD'  => 'Impossible de déplacer le fichier uploadé',
